          ...
          <div className="bottom">
            <form onSubmit={handleSubmit}>
              <div className="flex gap-3 w-[33vw]">
                <div className="flex flex-col w-full ">
                  ...
                  <input
                    ...
                    className="border-1 border-gray-500 pl-2 py-1 h-[40px] w-full rounded-xl mb-3"
                    required
                  />
                </div>
                <div className="flex flex-col w-full">
              ...
              <div className="flex flex-col gap-3 items-center mt-2">
                ...
                <button
                  className="bg-white w-[33vw] py-2 rounded-xl text-black border-gray-500 border-1"
                  type="button"
                >
                  <Link
                    to="/"
